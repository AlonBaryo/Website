...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function CheckForm() {
            ...
            if (n.length == 0) {
                document.getElementById("mUsername").value = "Enter a username";
            ...
            else
            {
                if (n.length < 2 || n.length > 15) {
                    document.getElementById("mUsername").value = "2 - 15 letters";
                    document.getElementById("mUsername").style.visibility = "visible";
                    flag = false;
                }
                else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <center>
    <h1> Registeration <align="center"></align> </h1>
    <table width="30%" align="center">
        ...
        <tr>
            ...
            <td><input type="text" id="Username" name="Username"  size="15" /></td>
             <td><input type="text" id="mUsername" name="mUsername" style="visibility:hidden;font-weight:bold;" disabled="disabled"/></td>
        </tr>
        <tr>
                <td>Password</td>
